...
const AboutPage: React.FC = () => {
  return (
    <div className="about-container">
      <h2>About FindAJob</h2>
      
      <section className="about-section">
        <h3>Our Mission</h3>
        <p>
          FindAJob aims to connect talented individuals with their dream jobs by providing
      ...
      <section className="about-section contact-info">
        <h3>Contact Us</h3>
        <p>Email: findajob@mail.com</p>
        <p>Phone: +234 123 456 7890</p>
        <p>Address: 13 Technology Street, Lagos, Nigeria</p>
      </section>
    </div>
  );
};
